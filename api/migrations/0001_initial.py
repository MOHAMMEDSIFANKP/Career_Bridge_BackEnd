    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('jobField', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='dashboard.jobfield')),
                ('jobTitle', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='dashboard.jobtitle')),
